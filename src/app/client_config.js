...
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'stemGeeks';
export const APP_NAME_UPPERCASE = 'STEMGEEKS';
export const APP_ICON = 'stemgeeks';
...
export const TAG_LIST = fromJSOrdered(['science', 'technology', 'engineering', 'math']);
...
export const VESTING_TOKEN = 'STEM POWER';
